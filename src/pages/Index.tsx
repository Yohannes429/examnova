          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-slide-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" variant="accent" className="text-lg px-8" onClick={() => window.location.href = "/auth"}>
                  <Users className="mr-2" size={20} />
                  Start Teaching
                </Button>
                <Button size="lg" variant="hero" className="text-lg px-8" onClick={() => window.location.href = "/auth"}>
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="hero" className="text-lg px-8 border-primary-foreground/30" onClick={() => window.location.href = "/auth"}>
